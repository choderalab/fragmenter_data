...
sbn.distplot(pfizer_results['[15, 25]']['wbo_dist'], rug=True, hist=False, color=sbn.color_palette()[2])
sbn.distplot(pfizer_results['[15, 25]']['wbo_dist'], hist=False, color=sbn.color_palette()[2])
