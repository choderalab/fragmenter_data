"""
Fragment with WBO heuristic for growth path
"""
...
def fragment_bond(mapped_mol, bond, threshold,  keep_confs=-1):
    ...
    f._build_fragment(bond, heuristic='wbo', strict_types=False, keep_confs=keep_confs, strict_stereo=False)
...
if __name__ == '__main__':
    ...
    with open('{}/{}_wbo_dists_wbo_path.json'.format(name, name), 'w') as f:
