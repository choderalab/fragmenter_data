...
name = 'Alvimopan_0'
bonds = [(13, 26)]
optimal_smiles = ['[H][C@]1(C[N@H+](CCC1)C[C@@H](C(=O)NCC(=O)[O-])C)[H]']
optimal_mapped_smiles = ["[H:54][CH:22]([C@@:25]([C:24]([N@+:27]1([C:16]([C:15]([CH2:19][C@@:18]([C:17]1([H:45])[H:46])([H:47])[H])([H:41])[H:42])([H:43])[H:44])[H:62])([H:58])[H:59])([C:13](=[O:29])[N:26]([C:23]([C:14](=[O:30])[O-:28])([H:56])[H:57])[H:61])[H:60])[H:55]"]
