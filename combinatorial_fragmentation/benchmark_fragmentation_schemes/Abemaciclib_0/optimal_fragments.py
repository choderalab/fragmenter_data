...
name = 'Abemaciclib_0'
bonds = [(14, 34), (34, 16)]
optimal_smiles = ['CN1CC[NH+](CC1)Cc2ccc(nc2)Nc3ncccn3',
                  'CN1CC[NH+](CC1)Cc2ccc(nc2)Nc3ncccn3']
optimal_mapped_smiles = ["[H:43][c:6]1[cH:12][cH:13][n:31][c:16]([n:29]1)[N:34]([H:69])[c:14]2[c:2]([c:1]([c:8]([c:5]([n:28]2)[H:42])[C:25]([H:64])([H:65])[N+:35]3([C:19]([C:17]([N:33]([C:18]([C:20]3([H:50])[H:51])([H:46])[H:47])[CH:26]([H:66])[H:67])([H:44])[H:45])([H:48])[H:49])[H:70])[H:38])[H:39]",
    "[H:43][c:6]1[cH:12][cH:13][n:31][c:16]([n:29]1)[N:34]([H:69])[c:14]2[c:2]([c:1]([c:8]([c:5]([n:28]2)[H:42])[C:25]([H:64])([H:65])[N+:35]3([C:19]([C:17]([N:33]([C:18]([C:20]3([H:50])[H:51])([H:46])[H:47])[CH:26]([H:66])[H:67])([H:44])[H:45])([H:48])[H:49])[H:70])[H:38])[H:39]"]
...
for i, bond in enumerate(bonds):
    ...
    plt.figure()
    sbn.kdeplot(omega_benchmark_results[ser_bond]['parent']['wbo_dist'], shade=True, color=sbn.color_palette('colorblind')[9], label='parent molecule')
    sbn.distplot(omega_benchmark_results[ser_bond]['parent']['wbo_dist'], rug=True, hist=False, color=sbn.color_palette('colorblind')[9])
