...
name = 'Ranitidine_0'
bonds = [(6, 14), (15, 6)]
optimal_smiles = ['CN/C(=C\[N+](=O)[O-])/NCCSC',
                  'CN/C(=C\[N+](=O)[O-])/NCCSC']
optimal_mapped_smiles = [ "[H:36][CH:11]([H:37])[S:21][C:13]([H:40])([H:41])[C:12]([H:38])([H:39])[N:15]([H:43])/[C:6](=[C:5](\\[H:24])/[N+:17](=[O:19])[O-:18])/[N:14]([H:42])[C:7]([H:25])([H:26])[H:27]",
