...
name = 'Pixantrone_1'
bonds = [(11, 22), (15, 6)]
optimal_smiles = ['CCNc1cccc2c1C(=O)c3cnccc3C2']
                  #'CN/C(=C\[N+](=O)[O-])/NCCSC']
optimal_mapped_smiles = ["[H:25][c:1]1[cH:10][c:8]2[c:9]([c:11]([c:2]1[H:26])[N:22]([H:43])[C:17]([H:36])([H:37])[CH:15]([H:32])[H:33])[C:13](=[O:24])[c:7]3[c:5]([n:18][c:4]([c:3]([c:6]3[CH2:12]2)[H:27])[H:28])[H:29]"]
#"[H:36][CH:11]([H:37])[S:21][C:13]([H:40])([H:41])[C:12]([H:38])([H:39])[N:15]([H:43])/[C:6](=[C:5](\\[H:24])/[N+:17](=[O:19])[O-:18])/[N:14]([H:42])[C:7]([H:25])([H:26])[H:27]"]
