...
sbn.kdeplot(pfizer_results[ser_bond]['wbo_dist'], shade=True)
sbn.distplot(pfizer_results[ser_bond]['wbo_dist'], rug=True, hist=False, color=sbn.color_palette()[2])
sbn.distplot(pfizer_results[ser_bond]['wbo_dist'], hist=False, color=sbn.color_palette()[2])
...
wbos = [results['parent']['elf10_wbo'], results['0.03_path_length_False_None']['elf10_wbo'],  pfizer_results[ser_bond]['elf10_wbo']]
frags = [results['parent']['frag'], results['0.03_path_length_False_None']['frag'], pfizer_results[ser_bond]['frag']]
visualize_mols(frags, cols=2, rows=2, bond_idx=bond, colors=colors, wbos=wbos, fname='fragments.pdf', align_to=0)