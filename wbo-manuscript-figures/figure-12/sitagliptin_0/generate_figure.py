...
with open('Sitagliptin_0_wbo_dists.json', 'r') as f:
    results = json.load(f)
results = results['[9, 20]']
with open('Sitagliptin_0_pfizer_wbo_dists.json', 'r') as f:
...
sbn.kdeplot(pfizer_results['[9, 20]']['wbo_dist'], shade=True)
sbn.distplot(pfizer_results['[9, 20]']['wbo_dist'], rug=True, hist=False, color=sbn.color_palette()[3])
sbn.distplot(pfizer_results['[9, 20]']['wbo_dist'], hist=False, color=sbn.color_palette()[3])
...
wbos = [results['parent']['elf10_wbo'], results['0.03_path_length_False_None']['elf10_wbo'],
        results['0.1_path_length_False_None']['elf10_wbo'], pfizer_results['[9, 20]']['elf10_wbo']]
frags = [results['parent']['frag'], results['0.03_path_length_False_None']['frag'],
         results['0.1_path_length_False_None']['frag'], pfizer_results['[9, 20]']['frag']]
visualize_mols(frags, cols=2, rows=2, bond_idx=(9, 20), colors=colors, wbos=wbos, fname='fragments.pdf', align_to=0)