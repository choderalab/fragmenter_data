...
sbn.distplot(pfizer_results['[14, 7]']['wbo_dist'], rug=True, hist=False, color=sbn.color_palette()[1])
sbn.distplot(pfizer_results['[14, 7]']['wbo_dist'], hist=False, color=sbn.color_palette()[1])

sbn.kdeplot(results['0.03_path_length_False']['wbo_dist'], shade=True)
sbn.distplot(results['0.03_path_length_False']['wbo_dist'], rug=True, hist=False, color=sbn.color_palette()[2])
sbn.distplot(results['0.03_path_length_False']['wbo_dist'], hist=False, color=sbn.color_palette()[2])
...
wbos = [results['parent']['elf10_wbo'], pfizer_results['[14, 7]']['elf10_wbo'], results['0.03_path_length_False']['elf10_wbo']]
frags = [results['parent']['frag'], pfizer_results['[14, 7]']['frag'], results['0.03_path_length_False']['frag']]
