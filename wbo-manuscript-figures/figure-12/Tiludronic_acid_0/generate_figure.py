...
with open('Tiludronic_acid_0_wbo_dists.json', 'r') as f:
    results = json.load(f)
results = results['[16, 7]']
with open('Tiludronic_acid_0_pfizer_wbo_dists.json', 'r') as f:
...
sbn.kdeplot(pfizer_results['[16, 7]']['wbo_dist'], shade=True)
sbn.distplot(pfizer_results['[16, 7]']['wbo_dist'], rug=True, hist=False, color=sbn.color_palette()[1])
sbn.distplot(pfizer_results['[16, 7]']['wbo_dist'], hist=False, color=sbn.color_palette()[1])
...
wbos = [results['parent']['elf10_wbo'], pfizer_results['[16, 7]']['elf10_wbo']]
frags = [results['parent']['frag'], pfizer_results['[16, 7]']['frag']]
visualize_mols(frags, cols=3, rows=1, bond_idx=(16, 7), colors=colors, wbos=wbos, fname='fragments.pdf', align_to=0)