...
sbn.distplot(pfizer_results[bond]['wbo_dist'], rug=True, hist=False, color=sbn.color_palette()[3])
sbn.distplot(pfizer_results[bond]['wbo_dist'], hist=False, color=sbn.color_palette()[3])
