...
wbos = [results['parent']['elf10_wbo'], pfizer_results[bond]['elf10_wbo'], results['0.03_path_length_False_None']['elf10_wbo'],
        results['0.1_path_length_False_None']['elf10_wbo']]
frags = [results['parent']['frag'], pfizer_results[bond]['frag'], results['0.03_path_length_False_None']['frag'],
         results['0.1_path_length_False_None']['frag']]
