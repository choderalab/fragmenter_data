...
sbn.distplot(results['0.03_path_length_False_None']['wbo_dist'], rug=True, hist=False, color=sbn.color_palette()[0])
sbn.distplot(results['0.03_path_length_False_None']['wbo_dist'], hist=False, color=sbn.color_palette()[0])
...
wbos = [results['parent']['elf10_wbo'], pfizer_results[bond]['elf10_wbo']]
frags = [results['parent']['frag'], pfizer_results[bond]['frag']]
